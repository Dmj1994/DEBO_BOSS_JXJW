...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5><strong id="s_user_name"></strong>转移给以下咨询师</h5>
                </div>
                <div class="ibox-content" style="padding:15px">
                    <form class="layui-form" action="../../boss/crm/transStudent" id="distribute_form">
                        ...
                        <div class="layui-form-item" id="div_all_consult_parent">
                            <div id="div_all_consult">
                                ...
                                <c:forEach var="consult" items="${consults}">
                                    <input type="radio" name="consultIds" lay-skin="primary" title="${consult.userName}" value="${consult.uuid}"
                                           class="consultIds">
                                </c:forEach>
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                                <button class="layui-btn" lay-submit="" lay-filter="save_btn">立即转移</button>
                        </div>
