...
<form class="layui-form" id="save_form" action="../boss/advice/saveAdvice" method="post">
    <div style="padding:20px">
        <div class="layui-form-item">
            <label class="layui-form-label">话术标题</label>
            <div class="layui-input-block">
                <input type="text" name="adviceTitle" lay-verify="required" class="layui-input" placeholder="必填">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <textarea id="adviceContent" style="display: none;" name="adviceContent"></textarea>
            </div>
        </div>
