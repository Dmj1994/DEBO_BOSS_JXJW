        ...
        <div class="row ">
            <div class="col-md-6">
                <div class="info_block_b floatBorder">
                    ...
                    <div class="layui-form-item">
                        <label class="layui-form-label required-field">学习目标</label>
                        <div class="layui-input-block " style="width:384px">
                ...
                <div class="info_block_c floatBorder" >
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-inline">
                            <label class="layui-form-label">是否已报名</label>
                            <div class="layui-input-block">
                                <input type="radio" name="isRegist" title="未报名"
                                       value="${studentVO.uuid}" ${studentVO.signupTime ==null ?"checked":""}
                                       lay-filter="cancelRegistRd">
                                <input type="radio" name="isRegist" title="已报名"
                                       value="${studentVO.uuid}" ${ studentVO.signupTime !=null ?"checked":""}
                                       lay-filter="isRegistRd">
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    layui.use(['form', 'layedit', 'laydate'], function () {
        ...
        form.on('radio(isRegistRd)', function (data) {
            showRgistDialog(data.value);
        });
        form.on('radio(cancelRegistRd)', function (data) {
            layer.confirm('确定取消报名？', {
                btn: [' 确定', '取消']
            }, function () {
                $.ajax({
                    url: "../boss/crm/cancelRgist",
                    data: {"studentId": data.value},
                    success: function (da) {
    ...
    var windowForChoose;
    function showRgistDialog(stuId) {
        $.ajax({
            url: "../boss/crm/showRgistDialog",
