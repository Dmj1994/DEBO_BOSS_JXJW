    ...
    <div style="padding:20px">
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline" style="width:300px">
                    <input type="radio" name="isValidate" title="有效"
                           value="1" ${student.isValidate == 1 ?"checked":""} >
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="preVisitTime" class="layui-input"
                           ...
                           readonly placeholder="系统自动获取，不需填">
                </div>
            </div>
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="orderTime" class="layui-input" id="input_order_time"
                           value="<fmt:formatDate value="${student.orderTime}"  pattern="yyyy-MM-dd HH:mm"/>">
                </div>
            </div>
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" class="layui-input" name="signupTime" id="input_registe_time"
                           value="<fmt:formatDate value="${student.signupTime}"  pattern="yyyy-MM-dd HH:mm"/>">
                </div>
            </div>
        ...
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
                <textarea placeholder="请输入内容" name="remark" class="layui-textarea">${student.remark}</textarea>
            </div>
        </div>

        <div class="layui-form-item">
            <div class="layui-input-block">
                <button class="layui-btn" lay-submit="" lay-filter="btn_feed_back">提交更新</button>
            </div>
        </div>
    </div>
</form>
